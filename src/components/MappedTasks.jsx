    ...
    return (
        <>
            <div className="flex justify-between items-center border-b-[0.5px] border-b-[#B8B6B6] ">
                <h3 className={`${tag === "Urgent" ? "text-[#F38383]" : "text-[#73C3A6]"
                ...
                <div className="font-[500] text-[24px] flex items-center gap-4 py-2">
                    <button className="bg-[#974FD0] cursor-pointer text-[#FAF9FB] w-[50px] 
                    md:w-[126px] h-[40px] md:h-[50px] rounded-[8px] flex items-center justify-center">
                        <Link to={`/task-Id/${_id}`} className="flex items-center gap-1">
                            <img src={editLogo} alt="edit-logo" className="w-8 h-8" />
                            <span className="hidden md:block">Edit</span>
                        </Link>
                    </button>
                    <button className="border-[#974FD0] border-1 cursor-pointer text-[#974FD0]
                     w-[50px] md:w-[126px] h-[40px] md:h-[50px] rounded-[8px] flex items-center justify-center gap-2 ">

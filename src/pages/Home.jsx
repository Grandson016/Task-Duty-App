    ...
    <main className= "wrapper grid lg:grid-cols-4 lg:gap-35 gap-10 items-center ">
      ...
      <section className = 'col-span-2 order-2 lg:order-1 md:pt-6'>
        ...
        <p className='font-[400] text-[20px] md:text-[24px] text-[#737171]'>
          TaskDuty is a task management app that helps you organize and prioritize your tasks efficiently. With TaskDuty, you can easily create, edit, and delete tasks, set deadlines, and track your progress.
        </p>
        <div className= 'mt-6'>
      ...
      <section className = ' col-span-2  order-1 lg:order-2  pt-8 '>
        <img src={heroImage} alt="hero-img.svg" className='w-full' />
